  ...
  return (
    <Box sx={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
      <TabContext value={value}>
        <Stack alignItems="center" justifyContent="space-between" width="100%" direction="row" sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <TabList
                ...
                <Box key={index2} sx={{ "&:last-child": { disply: "none" } }}>
                  <ListItem alignItems="flex-start">
                    <Stack spacing={2} direction="row" alignItems="center" sx={{ width: "100%" }}>
                      ...
                      <Typography sx={{ minWidth: "3%", textAlign: "center" }} variant="body">{index1 + 1}.{index2 + 1}</Typography>
                      <Divider orientation="vertical" variant="middle" flexItem />
                      <Stack direction="column" sx={{ marginLeft: "2.5% !important"}}>
